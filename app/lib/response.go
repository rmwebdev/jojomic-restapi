...
type Response struct {
	...
	ErrorData        *[]ErrorData `json:"error_data,omitempty" `        // Error fields
}
...
type ErrorData struct {
	...
	Value     interface{} `json:"value,omitempty"  example:"jane doe"` // value
	...
	Criteria  interface{} `json:"criteria,omitempty" example:"10"`    // criteria, example: if validator is gte (greater than) and criteria is 10, then it means a maximum of 10
